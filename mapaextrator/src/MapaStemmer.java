...
public class MapaStemmer {

  private static boolean m_CompMode = false;

  /** Tabelas hash contendo a lista de finais. */
  private static HashMap m_l13 = null;
  private static HashMap m_l12 = null;
  ...
  static {
    m_l13 = new HashMap();
    m_l13.put("alisticamente", "B");
    m_l13.put("arizabilidade", "A");

	m_l12 = new HashMap();
    m_l12.put("izacionadade", "B");
    m_l12.put("isacionadade", "B");
    m_l12.put("acionalmente", "B");

	m_l11 = new HashMap();
    m_l11.put("ancialidade", "A");
    m_l11.put("encialmente", "A");
    m_l11.put("ancialidade", "A");
    m_l11.put("encialidade", "A");
    m_l11.put("isticamente", "A");
    m_l11.put("izabilidade", "A");

	m_l10 = new HashMap();
    m_l10.put("alicamente", "C");
    m_l10.put("encializar", "A");

    m_l9 = new HashMap();
    m_l9.put("arisações", "A");
    m_l9.put("arizações", "A");
    m_l9.put("atividade", "A");
    m_l9.put("izacional", "A");
  ...
  /**
   * Encontra e remove o fim de uma palavra.
   */
  private String removeFinal(String word) {
	...
	switch (el) {
	case 13: conditionCode = (String)m_l13.get(ending);
	  break;
	case 12: conditionCode = (String)m_l12.get(ending);
	  break;
  ...
  /**
   * Recodifica o fim de uma palavra dada
   */
  private String recodificaFinal(String word) {
  ...
  /**
   * Retorna a versão stemmer da palavra fornceida
   * 
   * @param palavra é uma string contendo uma só palavra
   */
  public String stem(String palavra) {

    if (palavra.length() > 2) {
      return recodificaFinal(removeFinal(palavra.toLowerCase()));
    } else {
  ...
  /**
   * Faz o stemming da string
   */
  public String fazStemming(String str) {
  ...
  public static void main(String[] ops) {
    ...
    MapaStemmer ls = new MapaStemmer();
